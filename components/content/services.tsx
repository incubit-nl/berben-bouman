    ...
    <div className="bg-white py-24">
      <div className="container mx-auto px-6">
        ...
        <div className="mt-16 text-center">
          <Link
            href="/behandelingen"
            className="inline-flex items-center justify-center px-8 py-4 border border-transparent text-base font-semibold rounded-lg bg-accent-600 text-bg hover:bg-accent-700 shadow-md hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1"
          >
